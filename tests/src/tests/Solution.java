...
public class Solution {
	...
	int[] arr = new Random().ints(1, 102).limit(100).toArray();
	List<Integer> arrss = new ArrayList<Integer>();
	for (Integer i : arr) {
	    arrss.add(i);
	}
	Collections.shuffle(arrss);
	...
	System.out.println("\n");
	BagChooser bc = new BagChooser(arr, 2020);
	bc.recursionChooser(0);
